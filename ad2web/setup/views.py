...
def sslclient():
    ...
    form = SSLForm()
    form.multipart = True  # Enable file uploads
    if form.validate_on_submit():
        ...
        # Update or create certificate records in the database
        # TODO: Fix one() - should use first() or handle potential MultipleResultsFound/NoResultFound
